...
<body style="color: #B739FE">
	<div>
		 <form action="#" method="post" ><br>
            ...
            <br><br>
            <font color="#0303AC">
            	Enter ADM Number to UPDATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </font>
            <input class="input-box" type="VALUE" name="rollno" placeholder="ADMISSION NUMBER"><br>
...
echo '
	...
	<div >
		...
		<table>
			...
			<th>
				<tr>KISWAHILI</tr>&nbsp;&nbsp;&nbsp;&nbsp;
				<tr><input class="input-box"  type="text" name="cng-swa" value='; echo $swa; echo'>
			</th>
			<br><br>
			<th>
				<tr>PHYSICS</tr>&nbsp;&nbsp;&nbsp;&nbsp;
