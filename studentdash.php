...
Belive in originality&nbsp;&nbsp;!! Results announced  !!&nbsp;&nbsp;
...
if(isset($_POST['search'])) {
        ...
        if($num_row > 0){
            while($row = mysqli_fetch_array($res)){
                ...
                //this part is to chk if the pass and user name are correct
                    ...
                    echo '<script>alert("Results are ready scroll down to view")</script>';
                    $msg = 'yes';
                    break;
                }
    ...
    if($num_rows>0)
    {
        while($row=mysqli_fetch_array($res))
        {
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>ADM No.:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['roll'];
            echo "</td>";
           ...
           echo "<tr>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in Kiswahili:</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['kiswahili'];
            echo "</td>";
            ...
            echo "<tr>";
            echo "<td align='right' style='font-size:20px;'>Marks in Biology</td>";
            echo "<td><td>";
            echo "<td style='font-size:20px;'>";
            echo $row['be'];
            echo "</td>";
