...
<table style="font-size: 20px; color: #B739FE" align="center">
	<form action="#" method="POST" enctype="multipart/form-data">
		...
		<tr>
			...
			<td><input class="input-box" type="text" name="rl" placeholder="ADM Number"></td>
		</tr>
		<tr>
			<td align="right"><img src="https://img.icons8.com/nolan/64/father--v1.png"/></td>
			<td><input class="input-box" type="text" name="f-name" placeholder="Parent's Name"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input class="input-box" type="text" name="cnt-no" placeholder="Mobile Number"></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right">Marks in kiswahili:</td>
			<td><input class="input-box" type="number" name="swa"></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="right">Marks in Chemistry:</td>
			<td><input class="input-box" type="number" name="dsa"></td>
		</tr>
		<tr>
			<td align="right">Marks in Biology:</td>
...
if (isset($_POST['Submit'])) {
	...
	if (!$con) {
	   die("Connection failed");
		...
		$sql = "INSERT INTO `result`( `name`, `roll`, `fname`, `dob`, `contact`, `imgpath`, `maths`, `english`, `kiswahili`, `phy`, `dsa`, `be`) VALUES ('$std_name','$std_roll','$std_fname','$std_dob','$std_cont','$img_name','$maths','$eng', '$swa', '$phy','$dsa','$be')";
